    ...
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 space-y-1.5">
        ...
        <ul className="text-xs text-orange-700 leading-relaxed list-disc list-inside space-y-0.5">
          ...
          <li>과제가 완료되면 등록된 과제에서 &apos;과제 링크 / 결과물&apos;을 제출한 후 완료 처리해 주세요.</li>
        </ul>
      </div>
      ...
      <FormSection step={3} title="업무 내용">
        <TaskWorkFields
          currentWork={currentWork} onCurrentWorkChange={setCurrentWork}
          aiUsage={aiUsage} onAiUsageChange={setAiUsage}
          aiUsageFile={aiUsageFile} onAiUsageFileChange={setAiUsageFile}
        />
      </FormSection>
